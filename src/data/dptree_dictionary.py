...
class DPTreeWrapperPointerDictionary(PointerDict):

    def __init__(self, special_tokens=("pos", "neu", "neg"), pad='<pad>', eos='</s>', unk='<unk>', no_strip_node_label=False):
        super().__init__(special_tokens, pad, eos, unk)
        self.no_strip_node_label = no_strip_node_label
